...
namespace Reviewing.Infrastructure.Migrations
{
    ...
    [Migration("20230911144953_change subject group entity type defenition")]
    partial class changesubjectgroupentitytypedefenition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reviewing.Domain.AggregateModels.ReviewAggregate.Review", b =>
                {
                    ...
                    b.Property<int?>("Subject_Group")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("Subject_Group");
            ...
            modelBuilder.Entity("Reviewing.Domain.AggregateModels.ReviewAggregate.Review", b =>
                {
                    b.HasOne("Reviewing.Domain.Enumerations.SubjectGroups", null)
                        .WithMany()
